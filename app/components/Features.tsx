...
const Features = () => {
  return (
    <section id="features" className="py-5">
        <div className="w-[89%] m-auto max-w-[1440px] grid md:grid-cols-3 grid-cols-1 items-center justify-items-center gap-5">
            <div>
                <ul className="space-y-10">
                    <li>
                        ...
                        <p>Crafted with precision, our moonlamp radiates soft, ambient light and lasts for hours on a single charge.</p>
                    </li>
                    <li>    
                        <div className="flex gap-2 items-center text-xl font-bold text-dark">
